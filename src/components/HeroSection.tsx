...
import { Sparkles, Leaf } from "lucide-react"; // Restored Sparkles, Leaf icons

const HeroSection: React.FC = () => {
  return (
    <section className="relative w-full py-20 md:py-32 lg:py-48 bg-background text-center overflow-hidden rounded-xl shadow-2xl mb-12">
      {/* Restored Background elements for visual interest */}
